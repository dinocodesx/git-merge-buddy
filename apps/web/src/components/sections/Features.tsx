...
const FeatureCard = ({
  ...
  <div
    className={`group relative bg-zinc-900/50 p-8 border-2 border-primary/10 hover:border-primary hover:shadow-brutal transition-all hover:z-10 flex flex-col h-full ${className}`}
  >
...
export const Features = () => (
  <section
    id="features"
    className="bg-black border-y-4 border-primary py-24 px-6 transition-colors"
  >
    <div className="max-w-7xl mx-auto">
      <div className="mb-20 space-y-4">
        <h2 className="text-4xl md:text-6xl text-white uppercase font-space font-black">
          Tested Examples
        </h2>
        <p className="text-lg md:text-2xl font-bold opacity-60 text-primary uppercase">
